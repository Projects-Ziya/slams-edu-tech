...
export default function OpeningPositions() {
  return (
    <div id="positions">
      <div className="space-y-8 ">
        <h2 className="text-[26px] sm:text-[32px] md:text-[36px] lg:text-[40px] 3xl:text-[50px] mt-2 sm:mt-14 md:mt-6 3xl:mt-12 mb-12 sm:mb-14 md:mb-16 3xl:mb-20 font-medium leading-snug">
        ...
        <div className="relative rounded-2xl overflow-hidden mb-10">
          ...
          <h1 className="absolute bottom-4 sm:bottom-5 left-4 sm:left-6 3xl:bottom-8 3xl:left-10 text-[10px] sm:text-xs 3xl:text-base text-gray-200 max-w-[250px] sm:max-w-md 3xl:max-w-2xl">
          ...
          <Link key={job.id} to={`/careers/${job.id}`}>
            <div className="relative group">
              <div className="flex items-center justify-between pb-8 sm:pb-10 md:pb-12 pt-8 sm:pt-10 md:pt-12">
                <div>
                  <h3 className="text-[20px] sm:text-[24px] md:text-[28px] lg:text-[30px] 3xl:text-[38px] font-medium group-hover:text-blue-300">
                    {job.title}
                  </h3>
                  <p className="text-gray-400 text-[14px] sm:text-[18px] md:text-[20px] lg:text-[24px] 3xl:text-[30px] mt-1">
                    {job.type}
                  </p>
                </div>
      ...
      <div className="mt-16 3xl:mt-24 bg-gradient-to-r from-[#1a1a1a] to-[#2a2a2a] rounded-xl p-6 sm:p-7 md:p-8 3xl:p-12">
        <div className="flex justify-between items-center pb-6 sm:pb-7 md:pb-8">
          <h3 className="text-[14px] sm:text-base md:text-lg 3xl:text-2xl font-medium">
            Ready to Start Your IT Career?          </h3>

          <Link to="/#contact">
            <button className="bg-white text-black text-[12px] sm:text-sm 3xl:text-lg px-4 sm:px-5 py-2 3xl:px-8 3xl:py-3.5 rounded transition-all duration-300 
  hover:-translate-y-1 hover:bg-gray-200">
        ...
        <p className="text-gray-200 text-[12px] sm:text-[13px] md:text-sm 3xl:text-base max-w-xl 3xl:max-w-3xl">
